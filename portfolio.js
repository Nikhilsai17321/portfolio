(function () {
    ...
    function updateHeader() {
        ...
        // Add the scrolled class after moving down 40px.
    ...
    /* ===================================================
       ...
       click outside and focus restoration
       =================================================== */
    ...
    document.addEventListener('keydown', function (e) {
        ...
        // Shift + Tab on the first element goes to the last element.
        if (e.shiftKey && document.activeElement === first) {
            e.preventDefault();
            last.focus();

        // Tab on the last element goes back to the first element.
    ...
    document
        ...
        .forEach(function (link) {
            ...
            link.addEventListener('click', function (e) {
                ...
                // Ignore links that don't point to an existing element.
                if (!targetEl) {
                    return;
                }
    ...
    function setActiveSection(id) {
        ...
        // Update the circuit trace nodes.
